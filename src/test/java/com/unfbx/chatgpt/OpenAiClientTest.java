...
//        v2 = new OpenAiClient("sk-******************************************",60,60,60);
        v2 = new OpenAiClient("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",160,160,160,null);
    }
    ...
    public void completions() {
        CompletionResponse completions = v2.completions("写一份党组织生活会个人问题整改清单");
...
//        Edit edit = Edit.builder().input("我爱你麻麻").instruction("帮我修改错别字").model(Edit.Model.TEXT_DAVINCI_EDIT_001.getName()).build();
    ...
    public void genImagesV2() {
        ImageResponse imageResponse = v2.genImages("动物园");
        System.out.println(imageResponse);
    }
